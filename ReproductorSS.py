...
def abrir_archivo():
	global direcion, pos, n,cancion_actual, actualizar
	pos = 0
	n = 0
...
estilo1.configure("Horizontal.TProgressbar", foreground='red', background='black',troughcolor='DarkOrchid1',bordercolor='#970BD9',lightcolor='#970BD9', darkcolor='black')
...
atras = Button(frame2, image= imagen6, bg='orange',command= lambda:[retroceder(), iniciar()])
atras.grid(column=5, row=2, pady=10)
adelante = Button(frame2, image= imagen7, bg='green',command=lambda:[adelantar(), iniciar()])
...
trye = Button(frame2, image= imagen5, bg='green2',command=lectura)
trye.grid(column=9, row=2, pady=10)
